...
create or replace view "Павловский парк"."Бассейны i1" as
...
select "osm_id",
 ...
 where l.osm_id in ( 311755122, 989802564, 149099013, 311760730, 860606686, 874567225, 315726043, 93591935, 845847454)
),
b1 as (
select "osm_id",
       "osm_type",
...
select "osm_id",
 ...
 USING ( select ST_Union("Бассейн") "Бассейн", "0_osm_id", "0_osm_type"
           from "Павловский парк"."Бассейны i1"
...
select "osm_id",
       ...
       0::smallint "Шаг" 
  from "Павловский парк"."OSM ∀" l
 where l.osm_id in ( 311755122, 989802564, 149099013, 3174801445, 860606686, 874567225, 315726043, 93591935);
